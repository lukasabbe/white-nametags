...
tasks {
    processResources {
        ...
        val isLatestVersion = stonecutter.eval(stonecutter.current.version, ">=1.21.9")
        val extraMixinFile = if (isLatestVersion) "transparentname.latest.mixins.json" else "transparentname.mixins.json"
        ...
        val props = buildMap {
            ...
            inputs.property("extra_mixin_file", extraMixinFile)
            set("extra_mixin_file", extraMixinFile)
        }
